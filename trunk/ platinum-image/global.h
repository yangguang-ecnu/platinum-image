...
enum VIEWPORT_TYPE {PT_MPR, PT_MIP, VTK_EXAMPLE, VTK_MIP, VTK_ISOSURF, PT_CURVE, PT_HIST};
...
enum RENDERER_TYPE {RENDERER_MPR=0, RENDERER_MIP=1, NUM_RENDERER_TYPES, NUM_RENDERER_TYPES_PLUS_END, RENDERER_CURVE = 2, RENDERER_HIST};
