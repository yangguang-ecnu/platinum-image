...
{	
	public:
		...
		virtual double get_complex(int i) const{return -1;};
		virtual double get_magnitude(int i) const{return -1;};
		virtual double get_phase(int i) const{return -1;};
		
		virtual int get_data_size() const = 0;
		virtual RGBvalue* get_color() const = 0;
		virtual char get_line() const = 0;
		virtual double get_max(SPECTRUM_TYPE t = SP_REAL) {return -1;};
		virtual double get_min(SPECTRUM_TYPE t = SP_REAL) {return -1;};
